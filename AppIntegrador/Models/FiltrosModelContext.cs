namespace AppIntegrador.Models
{
    ...
    public partial class FiltrosEntities : DbContext
    {
        ...
        public virtual IQueryable<ObtenerFormulariosFiltros> ObtenerFormulariosFiltros(DataTable FiltroUnidadesAcademicas, DataTable FiltroCarrerasEnfasis, DataTable FiltroGrupos, DataTable FiltroProfesores)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteStoreQuery<ObtenerFormulariosFiltros>("SELECT FCodigo, FNombre, CSigla, GNumero, GSemestre, GAnno, FechaInicio, FechaFin FROM [ObtenerFormulariosFiltros](@UnidadesAcademicas, @CarrerasEnfasis, @Grupos, @CorreosProfesores)", FiltroUnidadesAcademicasParameter, FiltroCarrerasEnfasisParameter, FiltroGruposParameter, FiltroProfesoresParameter).AsQueryable();
        }
    }
}