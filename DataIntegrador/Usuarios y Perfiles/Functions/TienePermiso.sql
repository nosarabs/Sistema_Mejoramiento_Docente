...
permisos y perfiles. Este procedimiento devuelve TRUE si el usuario con el correo ingresado, con el perfil en la carrera y el 
énfasis seleccionado tiene el permiso indicado, FALSE en caso contrario.*/

CREATE FUNCTION [dbo].[TienePermiso]
(
